...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="<?=base_url('public/guest/images/logo.png')?>" alt="alternative"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#contact">LOGIN</a>
                </li>
            </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="<?=base_url('public/guest/images/intro-office.jpg')?>" alt="alternative">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?=base_url('public/guest/images/services-1.jpg')?>" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?=base_url('public/guest/images/services-2.jpg')?>" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="<?=base_url('public/guest/images/services-3.jpg')?>" alt="alternative">
                        </div>
                        <div class="card-body">
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=base_url('public/guest/images/testimonial-1.jpg')?>" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=base_url('public/guest/images/testimonial-2.jpg')?>" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=base_url('public/guest/images/testimonial-3.jpg')?>" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=base_url('public/guest/images/testimonial-4.jpg')?>" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=base_url('public/guest/images/testimonial-5.jpg')?>" alt="alternative">
                                        <div class="card-body">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-image" src="<?=base_url('public/guest/images/testimonial-6.jpg')?>" alt="alternative">
                                        <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="grid">
                        <div class="element-item development">
                            <a class="popup-with-move-anim" href="#project-1"><div class="element-item-overlay"><span>Online Banking</span></div><img src="<?=base_url('public/guest/images/project-1.jpg')?>" alt="alternative"></a>
                        </div>
                        <div class="element-item development">
                            <a class="popup-with-move-anim" href="#project-2"><div class="element-item-overlay"><span>Classic Industry</span></div><img src="<?=base_url('public/guest/images/project-2.jpg')?>" alt="alternative"></a>
                        </div>
                        <div class="element-item design development marketing">
                            <a class="popup-with-move-anim" href="#project-3"><div class="element-item-overlay"><span>BoomBap Audio</span></div><img src="<?=base_url('public/guest/images/project-3.jpg')?>" alt="alternative"></a>
                        </div>
                        <div class="element-item design development marketing">
                            <a class="popup-with-move-anim" href="#project-4"><div class="element-item-overlay"><span>Van Moose</span></div><img src="<?=base_url('public/guest/images/project-4.jpg')?>" alt="alternative"></a>
                        </div>
                        <div class="element-item design development marketing seo">
                            <a class="popup-with-move-anim" href="#project-5"><div class="element-item-overlay"><span>Joy Moments</span></div><img src="<?=base_url('public/guest/images/project-5.jpg')?>" alt="alternative"></a>
                        </div>
                        <div class="element-item design marketing seo">
                            <a class="popup-with-move-anim" href="#project-6"><div class="element-item-overlay"><span>Spark Events</span></div><img src="<?=base_url('public/guest/images/project-6.jpg')?>" alt="alternative"></a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-7"><div class="element-item-overlay"><span>Casual Wear</span></div><img src="<?=base_url('public/guest/images/project-7.jpg')?>" alt="alternative"></a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-8"><div class="element-item-overlay"><span>Zazoo Apps</span></div><img src="<?=base_url('public/guest/images/project-8.jpg')?>" alt="alternative"></a>
                        </div>
                    </div> <!-- end of grid -->
                    <!-- end of filter -->
    ...
    <div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-1.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
    ...
    <div id="project-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-2.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
    ...
    <div id="project-3" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-3.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>BoomBap Audio</h3>
                <hr class="line-heading">
    ...
    <div id="project-4" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-4.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Van Moose</h3>
                <hr class="line-heading">
    ...
    <div id="project-5" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-5.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Joy Moments</h3>
                <hr class="line-heading">
    ...
    <div id="project-6" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-6.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Spark Events</h3>
                <hr class="line-heading">
    ...
    <div id="project-7" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-7.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Casual Wear</h3>
                <hr class="line-heading">
    ...
    <div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="<?=base_url('public/guest/images/project-8.jpg')?>" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Zazoo Apps</h3>
                <hr class="line-heading">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=base_url('public/guest/images/team-1.png')?>" alt="alternative">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=base_url('public/guest/images/team-2.png')?>" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=base_url('public/guest/images/team-3.png')?>" alt="alternative">
                        </div> <!-- end of image wrapper -->
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?=base_url('public/guest/images/team-4.png')?>" alt="alternative">
                        </div> <!-- end of image wrapper -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-xl-6">
                    <div class="image-container">
                        <img class="img-fluid" src="<?=base_url('public/guest/images/about.jpg')?>" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
    ...
    <!-- Scripts -->
    <script src="<?=base_url('public/guest/js/jquery.min.js')?>"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    ...
    <script src="<?=base_url('public/guest/js/jquery.easing.min.js')?>"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?=base_url('public/guest/js/swiper.min.js')?>"></script> <!-- Swiper for image and text sliders -->
    <script src="<?=base_url('public/guest/js/jquery.magnific-popup.js')?>"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?=base_url('public/guest/js/morphext.min.js')?>"></script> <!-- Morphtext rotating text in the header -->
    <script src="<?=base_url('public/guest/js/isotope.pkgd.min.js')?>"></script> <!-- Isotope for filter -->
    <script src="<?=base_url('public/guest/js/validator.min.js')?>"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
