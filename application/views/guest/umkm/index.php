<div ng-controller="umkmController">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><?=$umkm[$i]['nama']?></h3>
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="<?=base_url('umkm/detail/') . $umkm[$i]['id']?>">DETAILS</a>
                        </div>
                    </div>
                    <?php endfor;?>
